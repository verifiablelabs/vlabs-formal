...
at commit `a0f30dc547a73aaae8608d193f94035192404627` (main). Mirrored paths: `formal/` (Lake project, Lean+Mathlib v4.28.0), `src/verifiable_labs_envs/formal_spec/`, `tests/formal_spec/`, `formal-verification.yml`.
